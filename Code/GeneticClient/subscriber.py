...
"""
This class handles subscriptions and/or receiving messages from the Planner. 

We shouldn't have to modify this file. 
"""
...
class Subscriber:
    ...
    def registerSubscribers(self, ai_manager: AiManager):
        ...
        self.subscriber_functions = [method_name for method_name in dir(ai_manager)
                                     if
                                     callable(getattr(ai_manager, method_name)) and method_name.__contains__("receive")]
