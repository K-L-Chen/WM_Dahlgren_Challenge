"""
This file contains some utility variables/functions for the AI, to make the code more consise
"""
...
# def magnitude_sq(m1: float, m2: float, m3: float) -> float:
#     """
...
#     """
#     return magnitude_sq(x1 - x2, y1 - y2, z1 - z2)
